 ...
 * @LastEditTime: 2023-04-06 13:36:05
...
int main() {
  ...
  Eigen::Vector3d width = Eigen::Vector3d(1, 1, 1);
  Eigen::Array3d a_res = Eigen::Array3d(width);
  a_res(0) = 3;
  Eigen::Array3d a_width = Eigen::Array3d(width.x(), width.y(), width.z());
  std::cout << Eigen::Vector3d(a_res * a_width) + width << std::endl;
  return EXIT_SUCCESS;
}
